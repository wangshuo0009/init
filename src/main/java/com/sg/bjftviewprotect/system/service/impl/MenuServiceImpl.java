...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements MenuService {
    ...
    @Override
    public Page<Menu> searchMenu(MenuRequest menuRequest, String userId) {
        ...
        return menuMapper.selectMenu(page,menuRequest,roleChildIds);
    }

    public Object searchAllByType(Integer type) {
